...
This was a timeout-contract defect in the release orchestrator, not a failed Core build or test. The change does not loosen any inner command limit; it lets those existing fail-closed limits run to completion.
