...
* [실패 이력과 원인](failure-history.md) - Run 26–44와 이전에 확인된 실패군, 개선 및 현재 판정
...
* [Azure DevOps·Linux VM/ACA 근본원인 지식그래프](../../research/2026-09-07-azure-devops-linux-vm-root-cause.md) - Run 32–44와 Azure 배포 책임 경계의 공식 계약 대조, root-cause 분류, 목표 구조
