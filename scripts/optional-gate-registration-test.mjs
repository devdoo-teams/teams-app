...
const providerFixturePattern = /^(?:grok-(?:response-engine|bot-runtime|provider-runtime-adapter)|github-agent-tasks-[A-Za-z0-9-]+|external-collaboration-boundary|optional-provider-(?:build|registry|runtime))-test\.(?:mjs|ts)$/u;
