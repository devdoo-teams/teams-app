...
async function runLocalFlow(dataFile, jobDataFile) {
  ...
  try {
    ...
    assert(health.body.version === '1.0.9', 'health version comes from the Teams manifest');
...
async function runProductionAuthFlow(dataFile, jobDataFile) {
  ...
  try {
    ...
    assert(health.body.version === '1.0.9', 'production health reports the Teams manifest version');
